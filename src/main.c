...
int main() {
    ...
    invert_image(pixels, width, height, 3); // R, G, B -> 3 (RGBA -> 4)

    unsigned int write_err = loadbmp_encode_file("images/out/invert/pepper.bmp", pixels, width, height, LOADBMP_RGB);
